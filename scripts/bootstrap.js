...
files.forEach(shortName => {
  ...
  const name = shortName === `vue-keynote` ? shortName : `@keynote/${shortName}`
  ...
  if (args.force || !fs.existsSync(pkgPath)) {
    const json = {
      ...
      keywords: ['vue', 'keynote'],
      author: 'Rahul Kadyan',
      license: 'MIT',
      bugs: {
        url: 'https://github.com/keynote/keynote/issues'
      },
      homepage: `https://github.com/keynote/keynote/tree/master/packages/${shortName}#readme`
    }
